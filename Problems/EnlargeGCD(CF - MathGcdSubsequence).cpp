...
/*
  Vai dar um conjunto de números
  E quer que vc tire o mínimo número de números possíveis
  Tal que deixe o Gcd do conjunto inteiro maior

  Tira o Gcd de todo mundo, divide todos os números pelo Gcd
  E acha a maior subsequencia que tem gcd > 1
